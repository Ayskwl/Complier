...
<Field> → <Type> ‘_’ <Id_name> ‘;’
<Type> → ‘int’ | ‘char’| ‘float’ | ‘short’ | ‘long’| ‘double’
<Id_name> → <Letter><IdRem>
...
Начальный символ грамматики:
VT = {struct, int, char, float, double, short, long, signed, unsigned, void, {, }, ;, a, b, c, …, z, A, B, C, …, Z, _, 0,1,2, …, 9};

Множество нетерминальных символов:
VN = {<Struct>, <IdRem>, <Fields>, <Field>, <Type>, <Id>, <Id_name>, <Digit>, <Letter>}
